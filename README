.. -*- mode: rst -*-
==========================================
 Keyboards for the Central Huasteca Nahuatl language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Central Huasteca Nahuatl language. The data and implementations
...
The Central Huasteca Nahuatl keyboard sources can be acquired using the `Giella SVN
